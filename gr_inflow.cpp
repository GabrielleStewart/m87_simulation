...
void FixedOuterBoundary(MeshBlock *pmb, Coordinates *pcoord, AthenaArray<Real> &prim,
                   FaceField &bb, Real time, Real dt,
                   int il, int iu, int jl, int ju, int kl, int ku, int ngh);
...
void Mesh::InitUserMeshData(ParameterInput *pin) {
  ...
  EnrollUserBoundaryFunction(BoundaryFace::outer_x1, FixedOuterBoundary);
  return;
}
